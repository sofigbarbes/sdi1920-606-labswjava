...
// Botón Actualizar
		...
		botonActualizar.addActionListener(new ActionListener() {
			...
			/*
			 * @Override public void actionPerformed(ActionEvent arg0) { peticiones++;
			 * ObjectNode respuestaJSON; respuestaJSON = ClientBuilder.newClient()
			 * .target("http://localhost:3000/memoria") .request()
